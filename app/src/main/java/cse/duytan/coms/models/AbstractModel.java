...
/**
 * Created by lehoangdung on 8/3/2017.
 */
...
public class AbstractModel implements Serializable {
    ...
    public Boolean PAPER_ABSTRACT_WITHDRAWN;
    ...
    public AbstractModel(int PERSON_ID, int CONFERENCE_ID, String ORGANIZATION_NAME_1, String ORGANIZATION_NAME_2,
                         String ORGANIZATION_NAME_3, String ORGANIZATION_NAME_4, String ORGANIZATION_NAME_5, String CORRESPONDING_AUTHOR,
                         int PAPER_ID, String CONFERENCE_NAME, String PAPER_ABSTRACT_DEADLINE, String PAPER_ABSTRACT_TITLE,
                         String PAPER_ABSTRACT_TITLE_EN, int CONFERENCE_SESSION_TOPIC_ID, String CONFERENCE_SESSION_TOPIC_NAME,
                         String CONFERENCE_SESSION_TOPIC_NAME_EN, String PAPER_ABSTRACT_TEXT, String FULL_PAPER_OR_WORK_IN_PROGRESS,
                         int TYPE_OF_STUDY_ID, String TYPE_OF_STUDY_NAME, String TYPE_OF_STUDY_NAME_EN, int CONFERENCE_PRESENTATION_TYPE_ID,
                         String CONFERENCE_PRESENTATION_TYPE_NAME, String CONFERENCE_PRESENTATION_TYPE_NAME_EN, String FIRST_SUBMITTED_DATE,
                         String LAST_REVISED_DATE, Boolean FINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT, String FROM_DATE, String THRU_DATE,
                         Boolean PAPER_ABSTRACT_WITHDRAWN, int POSITION) {
    ...
    public Boolean getFINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT() {
    ...
    public Boolean getPAPER_ABSTRACT_WITHDRAWN() {
        return PAPER_ABSTRACT_WITHDRAWN;
    }

    public void setPAPER_ABSTRACT_WITHDRAWN(Boolean PAPER_ABSTRACT_WITHDRAWN) {
        this.PAPER_ABSTRACT_WITHDRAWN = PAPER_ABSTRACT_WITHDRAWN;
    }
