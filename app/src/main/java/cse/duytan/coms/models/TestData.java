...
public final class TestData {
    ...
    public static List<PointF> getMarks() {
        ...
        marks.add(new PointF(70, 60));
        marks.add(new PointF(570, 60));
        marks.add(new PointF(800, 60));
        marks.add(new PointF(70, 180));
        marks.add(new PointF(70, 300));
        marks.add(new PointF(70, 550));
        marks.add(new PointF(570, 250));
        marks.add(new PointF(800, 230));
        marks.add(new PointF(590, 500));
    ...
    public static List<String> getMarksName() {
        ...
        for (int i = 0; i < getMarks().size(); i++) {
            marksName.add("Shop " + (i + 1) + " x: " + getMarks().get(i).x + " y: " + getMarks().get(i).y);
        }
        return marksName;
    }
}
